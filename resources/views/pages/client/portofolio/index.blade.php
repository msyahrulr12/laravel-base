                ...
                @foreach ($datas as $data)
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                        <div class="bg-white rounded shadow-sm w-100">
                            <img src="{{ asset('storage/'.$data->banner) }}" alt="{{ $data->banner }}" class="img-fluid card-img-top">
                            <div class="p-4">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <a href="{{ route('portofolios.show', $data->id) }}" class="btn btn-primary w-100">Detail Program Kerja</a>
                            </div>
                            </div>
                        </div>
                    </div>
