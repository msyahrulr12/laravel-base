...
use App\Http\Requests\WorkProgramRequest;
...
class WorkProgramController extends BaseController
{
    private $model;
    private $baseRoute = 'admin.work_programs.';
    private $baseView = 'pages.admin.work_program.';
    private $title = 'Program Kerja';
    private $permission = 'work_programs';
    private $columns = [
        'banner' => [
            'title' => 'Banner',
    ...
    /**
     * Show the work_program for creating a new resource.
     *
     * @return \Illuminate\Http\Response
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(WorkProgramRequest $request)
    {
        $this->checkPermission('create '.$this->permission);
    ...
    /**
     * Show the work_program for editing the specified resource.
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(WorkProgramRequest $request, $id)
    {
        $this->checkPermission('update '.$this->permission);
